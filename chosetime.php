    ...
    <section>
        <div class="header-image-area">
             <div class="intro-text newsletter">
                <h3>Chose Time-slot </h3>
                <form action="controller.php" method="POST">
                        <!-- 
                        <select style="height:  40px;width:  200px" name="bookslottime">
                            <option value="t0">select</option>
                            <option value="t1">2 Hours</option>
                            <option value="t2">3 Hours</option>
                            <option value="t3">5 Hours</option>
                        </select> -->
                        <?php 

                            date_default_timezone_set('Asia/Kolkata'); 
                            $times1 = time();
                            $tos = date("h:i A",$times1);

                        ?>
                        <h3 style="color:white;">Current Time : <?php echo $tos;?></h3>
                        <input style="height: 40px;width:  130px" type="time" name="tmstart" required>
                        <input style="height:  40px;width: 130px" type="time" name="tmend" required>
                        <button type="submit" name="btntimeslot" style="width:  100px" class="subscribe">Next</button>
                </form>
            </div>
        </div>
    </section>
