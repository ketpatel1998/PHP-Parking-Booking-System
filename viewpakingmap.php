...
<head>
    <title>ParkAt | Parking Map View</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
========================-->
                            ...
                            <nav id="mobile-menu">
                                <ul>
                                    ...
                                    <?php
                                        ...
                                        ?>
                                    <li>
                                        <a class="current" href="viewpakingmap.php">parking map</a>
                                    </li>
                                    <?php
                                        if(isset($_SESSION["regno"]["name"]))
                                        {
    ...
    <div class="raw">
       ...
       <h4 style="color: red;text-align: center;">* For More Accuracy Go For Booking *</h4> 

       <?php
            $_SESSION["onlyview"]["name"] = "setup";
            if(isset($_SESSION["regno"]["name"]))
                                        {
