<?php
	...
	require "dao.php";
	$d = new dao();
    if(isset($_SESSION['destin']['id']))
    {   
        if($_SESSION['hour1']['id']!=null && $_SESSION['min1']['id']!=null && $_SESSION['hour2']['id']!=null && $_SESSION['min2']['id']!=null)
        {
        	if(isset($_SESSION["slot"]["id"]))
        	{

        		$reg = $_SESSION['regno']['name'];
        		$j = $d->getUserData("users_tbl",$reg);
        		$result=mysqli_fetch_array($j);
        		$_SESSION['name1']['id'] = $result['name'];
        		$_SESSION['email1']['id'] = $result['email'];
        		$_SESSION['phone1']['id'] = $result['phone'];
    ...
    <section>
        <div class="header-image-area">
             <div class="intro-text newsletter">
                ...
                <div style="height: 310px;width: 300px;margin-left: 542px;border-radius: 5px;border: 1px solid white;">
                	<h3 style="font-style: bold;margin-top: 15px;"><?php echo $_SESSION['destin']['id'];?></h3><hr style="margin:10px;background: white">
                	<p style="font-style: bold;margin-top: 15px;">Reg No : <?php echo $_SESSION['regno']['name'];?></p>
                	<p style="font-style: bold;margin-top: 15px;">Name : <?php echo $result['name'];?></p>

                	<p style="font-style: bold;margin-top: 15px;">Slot No : <?php echo $_SESSION['slot']['id'];?></p>
                	<p style="font-style: bold;margin-top: 15px;">Time duration : <?php echo $_SESSION['hour1']['id'].":".$_SESSION['min1']['id']." - ".$_SESSION['hour2']['id'].":".$_SESSION['min2']['id'];?></p>
                	<p style="font-style: bold;margin-top: 15px;">Email : <?php echo $result['email'];?></p>
                	<p style="font-style: bold;margin-top: 15px;">Phone No : <?php echo $result['phone'];?></p>



                </div>
    			<form action="controller.php" method="POST">
                        <input style="margin-top: 10px;margin-left: 30px;" type="submit" class="btn btn-primary" name="printbookticket" value="Confirm">
